...
public class TableTest {
    ...
    public void add_reservation_test() {
        ...
        Reservation reservation = new Reservation(costumer1, restaurant1, table1, date);
    ...
    public void add_two_reservations_same_table_test() {
        ...
        Reservation reservation = new Reservation(costumer1, restaurant1, table1, date);
        table1.addReservation(reservation);
        Reservation reservation2 = new Reservation(costumer1, restaurant1, table1, date2);
